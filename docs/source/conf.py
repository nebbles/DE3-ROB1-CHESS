# -*- coding: utf-8 -*-
#
# DE3-ROB1-CHESS documentation build configuration file, created by
...
htmlhelp_basename = 'DE3-ROB1-CHESSdoc'
...
latex_documents = [
    (master_doc, 'DE3-ROB1-CHESS.tex', u'DE3-ROB1-CHESS Documentation',
     u'Anna Bernbaum, Ben Greenberg, Josephine Latreille,\n Sanish Mistry, Leah Pattison, Paolo Ruegg, Sylvia Zhang', 'manual'),
]
...
man_pages = [
    (master_doc, 'de3-rob1-chess', u'DE3-ROB1-CHESS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DE3-ROB1-CHESS', u'DE3-ROB1-CHESS Documentation',
     author, 'DE3-ROB1-CHESS', 'One line description of project.',
     'Miscellaneous'),
]
...
autodoc_mock_imports = ["rospy", "std_msgs", "numpy", "cv2", "skimage", "imutils", "matplotlib", "scipy"]
